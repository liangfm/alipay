      ...
      //  $payment_response->getPostData();
       ...
       $arr=$_GET;
        ...
        $authorized = false;
               ...
               $this->module->validateOrder((int)$cart->id, Configuration::get('PS_OS_SHIPPING'), $total, $this->module->displayName, null, var_export($arr), (int)$currency->id, false, $customer->secure_key);
